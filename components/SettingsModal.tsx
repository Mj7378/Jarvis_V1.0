...
const SystemControls: React.FC<Pick<SettingsModalProps, 'onCameraClick' | 'isBusy' | 'onWeather' | 'onSelfHeal' | 'onShutdown'>> = (props) => {
    ...
    return (
        <div className="bg-background/20 p-4" style={{clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 15px), calc(100% - 15px) 100%, 0 100%)'}}>
...
const QuickActions: React.FC<Pick<SettingsModalProps, 'isBusy' | 'onDesignMode' | 'onSimulationMode'>> = (props) => {
    ...
    return (
        <div className="bg-background/20 p-4" style={{clipPath: 'polygon(15px 0, 100% 15px, 100% 100%, 0 100%, 0 0)'}}>
